      ...
      <div class="col-12 col-md-8 col-lg-6 col-xl-5">
        ...
        <span class="text-danger" id="msg"></span>
          ...
          <div class="form-floating mb-3" style="position: relative;">
            <input type="password" class="form-control rounded-4" id="password1" name="password" placeholder="Password" value="<?php if(isset($_COOKIE['qbtuyqug'])) echo $_COOKIE['qbtuyqug']; ?>" required>
            <label for="floatingPassword">Password</label>
          </div>

          <div class="form-floating mb-3">
            <input type="password" class="form-control rounded-4" id="password2" placeholder="Confirm Password" required>
            <label for="confirmPassword">Confirm Password</label>
            
          </div>
     
          <button type="button" id="signupBtn" value="" class="btn btn-primary btn-lg m-3 rounded-pill fw-bold w-50 mt-3">Sign up Account</button>
...
<script src="../src/jquery/signup.js"></script>