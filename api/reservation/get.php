...
$response = array();
            ...
            $query = "SELECT CONCAT(a.FirstName ,' ', a.LastName) AS reserved_by,p.PackageName,r.Date,r.Time,r.Created_at As reserved_date,r.Status,r.ReservationID,
            (SELECT SUM(Amount) FROM payment WHERE ReservationID = r.ReservationID) AS total_amount_pay,
